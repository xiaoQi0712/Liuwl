...
public class Cst_activity implements Serializable {
	...
	public String toString() {
		return "Cst_activity [atv_id=" + atv_id + ", atv_cust_id=" + atv_cust_id + ", atv_cust_no=" + atv_cust_no
				+ ", atv_cust_name=" + atv_cust_name + ", atv_date=" + atv_date + ", atv_place=" + atv_place
				+ ", atv_title=" + atv_title + ", atv_desc=" + atv_desc + "]";
	}
